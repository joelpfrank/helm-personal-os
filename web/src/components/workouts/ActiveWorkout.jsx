...
export default function ActiveWorkout() {
  ...
  const totalSetCount = active.exercises.reduce((count, exercise) => count + (exercise.sets?.length || 0), 0);
    ...
    <div className="active-workout">
      <div className="active-header">
        <div>
          ...
          <div className="active-session-meta" aria-live="polite">
            <span className="active-time muted">{elapsed(active.started_at)}</span>
            <span className="active-progress">{completedSetCount} of {totalSetCount} sets complete</span>
          </div>
        </div>
        <span style={{ flex: 1 }} />
