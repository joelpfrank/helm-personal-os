...
function ScoreChip({ score }) {
  ...
  return (
    <div className="food-score-chip" style={{ borderColor: color, color }} aria-label={`Food log score ${score} out of 100, estimate`}>
      <strong>{score}</strong>
      <span className="muted small" style={{ marginLeft: 4 }}>· estimate</span>
    </div>
  );
}
