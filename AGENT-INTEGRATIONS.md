...
Compatibility evidence on this page was last verified on **2026-07-30** against Helm `0.1.1`, Hermes Agent `0.18.2`, OpenClaw `2026.3.13`, and mcporter `0.9.0`. Commands from a newer host release may differ; check that release's own help before changing the examples.
...
For transport details, see [MCP integration](docs/MCP.md). For the full installer contract, see [Install Helm on your Mac](HERMES-INSTALL.md).
