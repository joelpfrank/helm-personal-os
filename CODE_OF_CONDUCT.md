...
reported through the repository's private vulnerability reporting form;
prefix the report title with "Conduct report". Do not use public issues to
report conduct violations. All complaints will be reviewed and investigated
promptly and fairly.

All project maintainers are obligated to respect the privacy and security
of the reporter of any incident.

When reporting, please avoid including anyone's real personal data beyond
what's necessary to describe the incident — see [CONTRIBUTING.md](CONTRIBUTING.md).
